...
GAIC(mSGum, mSJSU, mSLogi, mSNorm, mSNormFam, mSLQNO, mSSkewT1, mSSkewT2, mSSkewT3, mSSkewT4, mSSkewT5, mST)



month.Skew3.mod <- gamlss(percentage ~ month + Surface.Temp..C., 
               family = ST3(), 
               data = dolphins_standardized_month)

summary(month.Skew3.mod)
plot(month.Skew3.mod)
```
...
GAIC(ws_mSShash, ws_mSGenGa, ws_mSGum, ws_mSJSU, ws_mSLogi, ws_mSNorm, ws_mSNormFam, ws_mSLQNO, ws_mSReGE, ws_mShaOG, ws_mSSkewT1, ws_mSSkewT2, ws_mSSkewT3, ws_mSSkewT4, ws_mSSkewT5, ws_mST)
